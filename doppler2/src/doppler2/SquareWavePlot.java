...
public class SquareWavePlot extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        int frequency = 2;  // liczba okresów w szerokości panelu
    ...
    public void showEnlargedPlot() {
        JFrame frame = new JFrame("Enlarged Square Wave Plot");
        SquareWavePlot enlargedPlot = new SquareWavePlot();
